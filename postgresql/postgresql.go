...
type DB interface {
	...
	ExecxCtx(ctx context.Context, builder sq.Sqlizer) (commandTag pgconn.CommandTag, err error)
	Query(sql string, args ...interface{}) (pgx.Rows, error)
	QueryCtx(ctx context.Context, sql string, args ...interface{}) (pgx.Rows, error)
	QueryxCtx(ctx context.Context, builder sq.Sqlizer) (pgx.Rows, error)
	QueryRow(sql string, args ...interface{}) pgx.Row
	QueryRowCtx(ctx context.Context, sql string, args ...interface{}) pgx.Row
	QueryxRowCtx(ctx context.Context, builder sq.Sqlizer) pgx.Row
...
func (p *ConnectionPool) ExecxCtx(ctx context.Context, builder sq.Sqlizer) (commandTag pgconn.CommandTag, err error) {
	query, args, err := builder.ToSql()
	if err != nil {
		return nil, err
	}
	return p.ExecCtx(ctx, query, args...)
}

func (p *ConnectionPool) QueryxCtx(ctx context.Context, builder sq.Sqlizer) (pgx.Rows, error) {
	query, args, err := builder.ToSql()
	if err != nil {
		return nil, err
	}
	return p.QueryCtx(ctx, query, args...)
}

func (p *ConnectionPool) QueryxRowCtx(ctx context.Context, builder sq.Sqlizer) pgx.Row {
	query, args, err := builder.ToSql()
	if err != nil {
		return errRow{err}
	}
	return p.QueryRowCtx(ctx, query, args...)
}
...
func (t *Transaction) ExecxCtx(ctx context.Context, builder sq.Sqlizer) (commandTag pgconn.CommandTag, err error) {
	query, args, err := builder.ToSql()
	if err != nil {
		return nil, err
	}
...
func (t *Transaction) QueryxCtx(ctx context.Context, builder sq.Sqlizer) (pgx.Rows, error) {
	query, args, err := builder.ToSql()
	if err != nil {
		return nil, err
	}
	return t.QueryCtx(ctx, query, args...)
}

func (t *Transaction) QueryxRowCtx(ctx context.Context, builder sq.Sqlizer) pgx.Row {
	query, args, err := builder.ToSql()
	if err != nil {
		return errRow{err}
	}
	return t.QueryRowCtx(ctx, query, args...)
}
...
func (t *Transaction) BeginCtx(ctx context.Context) (*Transaction, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "create savepoint")
	}
	return t, nil
}
